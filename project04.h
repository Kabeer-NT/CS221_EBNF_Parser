...
#define SCAN_TOKEN_STRINGS {"TK_INTLIT", "TK_BINLIT", "TK_HEXLIT", \
       	"TK_LPAREN", "TK_RPAREN","TK_PLUS", "TK_MINUS", "TK_MULT", "TK_DIV","TK_RSHIFT","TK_LSHIFT",\
	"TK_NOT","TK_AND","TK_OR","TK_XOR","TK_EOT", "TK_ANY" };
...
//Prototype for the implementation of convert and eval tree
int eval_tree(struct parse_node_st*);
void convert(unsigned int, int base,int width);
